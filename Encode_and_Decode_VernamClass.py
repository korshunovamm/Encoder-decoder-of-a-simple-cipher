...
class CodeVernamClass:
    """Класс не является наследником класса AbstractClassEncryptor,
    так как не имеет значение,
    ...
    def code(self):
        ...
        encrypted - значение операции XOR для символа
        текста и соответствующкй буквы ключа
