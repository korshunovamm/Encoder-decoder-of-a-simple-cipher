...
lbl = Label(window, text="""Чтобы шифрование вашего исходного текста прошло успешно
рекомендуется выбирать файлы,
содержащие буквы одного алфавита(латинского/русского), за исключение быть может
шифрования/расшифрования шифром Вернама.
Для более детального ознакомления с программой, можно прочитать README.
Автоматический взлом шифра Цезаря не работает на текстах,
не содержащих хотя бы одну букву или содеожащих буквы разного алфавита.
